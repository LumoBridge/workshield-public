...
<div align="center">
  <img src="public/brand.veydigital_logoT.png" alt="WorkShield Logo" width="120" />

  <h1 style="color:#22c55e;">WorkShield</h1>
  <h3 style="color:#94a3b8;">Investor Overview</h3>
</div>

<br />

<div style="border:1px solid #1e293b; border-radius:12px; padding:20px; background:linear-gradient(180deg,#020617,#020617);">
...
<div style="border:1px solid #1e293b; border-radius:10px; padding:16px; background:#020617;">
...
<div style="border:1px solid #1e293b; border-radius:10px; padding:14px;">
...
<div style="border:1px solid #1e293b; padding:12px; border-radius:8px; text-align:center;">Not a legal platform</div>
<div style="border:1px solid #1e293b; padding:12px; border-radius:8px; text-align:center;">Not case management software</div>
<div style="border:1px solid #1e293b; padding:12px; border-radius:8px; text-align:center;">Not advisory or enforcement tooling</div>
